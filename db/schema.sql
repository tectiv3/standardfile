...
BEGIN TRANSACTION;
CREATE TABLE IF NOT EXISTS "items" ("uuid" varchar(36) primary key NULL, "content" blob NOT NULL, "content_type" varchar(255) NOT NULL, "enc_item_key" varchar(255) NOT NULL, "auth_hash" varchar(255) NOT NULL, "user_uuid" varchar(36) NOT NULL, "deleted" integer(1) NOT NULL DEFAULT 0, "created_at" timestamp NOT NULL, "updated_at" timestamp NOT NULL);
